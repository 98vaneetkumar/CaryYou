...
module.exports = {
    ...
    try {
      ...
      if (user && user.status === 0) {
        return commonHelper.failed(
          res,
          Response.failed_msg.notActiveAccountYet
        );
      }
    ...
    try {
      ...
      if (emailcheck) {
        ...
        return helper.success(
          res,
          Response.success_msg.alreadyExists,
          response
        );
      } else {
        let objToSave = {};
  ...
  addAdddress: async (req, res) => {
    try {
      ...
      if (result.modifiedCount > 0) {
        return commonHelper.success(
          res,
          Response.success_msg.address_add_success,
          response
        );
      } else {
        return commonHelper.error(
  ...
  listOfAddresses: async (req, res) => {
    try {
      ...
      return commonHelper.success(
        res,
        Response.success_msg.address_add_list,
        response
      );
    } catch (error) {
      console.log("error", error);
  ...
  deleteCard: async (req, res) => {
    try {
      ...
      return commonHelper.success(
        res,
        Response.success_msg.delete_card,
        response
      );
    } catch (error) {
  ...
  setDefaultCard: async (req, res) => {
    try {
      ...
      return commonHelper.success(
        res,
        Response.success_msg.defaultCard_success
      );
    } catch (error) {
      console.log(error);
      throw error;
  ...
  createPaymentUsingCard: async (req, res) => {
    try {
      ...
      if (response.status === "succeeded") {
        return commonHelper.success(
          res,
          Response.success_msg.payment_success,
          response
        );
      } else {
        return commonHelper.error(
          res,
          Response.error_msg.payment_failed,
          response
        );
      }
    } catch (error) {
  ...
  transfer_payment: async (req, res) => {
    try {
      ...
      if (transfer && transfer.id) {
        return commonHelper.success(
          res,
          Response.success_msg.fundTransfer,
          response
        );
      }
    } catch (err) {
  ...
  addExternalBankAccount: async (req, res) => {
    try {
      ...
      return commonHelper.success(
        res,
        Response.success_msg.external_bank_success,
        result
      );
    } catch (error) {
  ...
  makeDefaultBankAccount: async (req, res) => {
    try {
      ...
      return commonHelper.success(
        res,
        Response.success_msg.default_bank_success,
        updatedBankAccount
      );
    } catch (error) {
  ...
  bankAccountList: async (req, res) => {
    try {
      ...
      return commonHelper.success(
        res,
        Response.success_msg.bankAccountList,
        bankAccounts
      );
    } catch (error) {
  ...
  deleteExternalAccount: async (req, res) => {
    try {
      ...
      return commonHelper.success(
        res,
        Response.success_msg.external_bank_delete_success
      );
    } catch (error) {
  ...
  createOrder: async (req, res) => {
    try {
      ...
      const demoOrder = {
        ...
        restaurant: "67544749f951a03119233b93", // Replace with a valid restaurant ID
        price: "29.99",
        item: "Samosa",
